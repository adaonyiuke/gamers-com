  ...
  async function runSeed() {
    ...
    try {
      ...
      if (missingGames.length > 0) {
        const gameInserts = [
          { group_id: groupId, name: "Catan", abbreviation: "CA", scoring_type: "highest_wins" },
          { group_id: groupId, name: "Ticket to Ride", abbreviation: "TI", scoring_type: "highest_wins" },
          { group_id: groupId, name: "Codenames", abbreviation: "CO", scoring_type: "manual_winner" },
